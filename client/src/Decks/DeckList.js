...
class DeckList extends Component {
    ...
    render() {
        const mappedDecks = this.props.decks.map(deck => <Link onClick={() => console.log(this.props.match)} to={`/category/${this.props.match.params.categoryName}/${deck._id}`} className="deckCard" style={{textDecoration: 'none'}}>
        ...
        return (
            <div style={{height: '100vh'}}>
                ...
                <Link to='/add' className="deckCard" style={{marginBottom: 40, textDecoration: 'none', color: 'blue'}}>
